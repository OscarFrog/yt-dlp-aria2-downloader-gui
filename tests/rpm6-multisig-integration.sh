...
# Independent future-proofing: build an actual package-format v6 fixture and
# qualify multi-signature semantics there.
build_v6_fixture
v6_rpm=${V6_RPM}
...
# Corrupt one known v6 signature and retain another valid known signature.
# RPM 6 requires every known/enabled signature to validate.
