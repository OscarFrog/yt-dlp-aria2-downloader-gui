...
development version is **2.3.26**.
The latest published package release is **2.3.26**.

## Recommended installation

Open the [latest GitHub release](https://github.com/OscarFrog/yt-dlp-aria2-downloader-gui/releases/latest).
The exact asset names below match the currently published v2.3.26 release.
...
it, then install it with `sudo apt install ./yt-dlp-aria2-downloader-gui_2.3.26-1_all.deb`.
...
gh release verify-asset v2.3.26 ./ARTIFACT -R OscarFrog/yt-dlp-aria2-downloader-gui
```
...
The latest published release, 2.3.26, provides an architecture-independent DEB
