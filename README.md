...
The exact asset names below match the currently published v2.3.17 release.
...
it, then install it with `sudo apt install ./yt-dlp-aria2-downloader-gui_2.3.17-1_all.deb`.
...
gh release verify-asset v2.3.17 ./ARTIFACT -R OscarFrog/yt-dlp-aria2-downloader-gui
```
...
The latest published release, 2.3.17, provides an architecture-independent DEB
