...
it, then install it with `sudo apt install ./yt-dlp-aria2-downloader-gui_2.2.3-1_all.deb`.
...
gh release verify-asset v2.2.3 ./ARTIFACT -R OscarFrog/yt-dlp-aria2-downloader-gui
```
...
Release 2.2.3 publishes an architecture-independent DEB aligned with the same
