...
| `CHANGELOG.md` | Documentation historique | Journal chronologique des releases et décisions | Utilisateurs, packaging, release, audit de versions | Oui — documentation/release | Oui — 2.3.6 courant et entrées anciennes figées | Oui — valeur historique explicite | Non, ne remplace pas les docs courantes | KEEP — HISTORIQUE |
...
| `download-video.sh` | Bash production | Moteur CLI pour une URL, média et publication finale | GUI, launchers, packages, tests réels/mocks | Oui — cœur d’exécution, installé | Oui — version 2.3.6 et interface/manpage alignées | Récupération de staging ancien volontaire | Non | KEEP |
